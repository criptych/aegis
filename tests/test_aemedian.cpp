...
TEST_CASE("median calculation", "[aeMedian]") {
    ...
    SECTION("two values [1 2]") {
        ...
        REQUIRE(md.count() == 2);
        CHECK(md.median() == Approx(2.0));
    }

    SECTION("sample data: [2, 4, 4, 4, 5, 5, 7, 9]") {
        double data[] = { 2, 4, 4, 4, 5, 5, 7, 9 };
        aeMedian md(std::begin(data), std::end(data));

        REQUIRE(md.count() == 8);
        CHECK(md.median() == Approx(5.0));
    }

    SECTION("sample data: [9, 7, 5, 5, 4, 4, 4, 2]") {
        double data[] = { 9, 7, 5, 5, 4, 4, 4, 2 };
        aeMedian md(std::begin(data), std::end(data));
